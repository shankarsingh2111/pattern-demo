package com.example.shankar.patterndemo.qrgenerator;
...
public class QRGSaver {
    ...
    public static boolean save(String saveLocation, String imageName, Bitmap bitmap, int imageFormat) throws WriterException {
